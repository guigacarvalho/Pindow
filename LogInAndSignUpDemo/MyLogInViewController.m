...
//    [self.logInView.signUpButton setTitle:@"Sign Up" forState:<#(UIControlState)#>
...
//    [self.logInView sendSubviewToBack:self.fieldsBackground];
    ...
    [self.logInView.logInButton setBackgroundImage:nil forState:UIControlStateApplication];
    [self.logInView.logInButton setTitleColor:[UIColor redColor] forState:UIControlStateNormal];
...
- (void)viewDidLayoutSubviews {
    ...
    [self.logInView.logInButton setFrame:CGRectMake(35.0f, 245.0f, 250.0f, 40.0f)];
